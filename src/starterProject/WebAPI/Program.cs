...
using Nova.Core.Localization.WebApi;
using Nova.Core.Mailing;
using Nova.Core.Persistence.WebApi;
using Nova.Core.Security.Encryption;
using Nova.Core.Security.JWT;
using Nova.Core.Security.WebApi.Swagger.Extensions;
using Persistence;
